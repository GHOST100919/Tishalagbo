            ...
            <div style={{
                ...
                <div style={{ flex: '1 1 220px', minWidth: '220px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '0.7rem' }}>
                        ...
                        <img src="/icon.png" alt="Organic Certification" style={{ width: '32px', height: '32px', borderRadius: '50%', boxShadow: '0 0 8px #00ffb3' }} />
                        <img src="/icon.png" alt="Trusted Brand" style={{ width: '32px', height: '32px', borderRadius: '50%', boxShadow: '0 0 8px #00c3ff' }} />
                    </div>
                </div>
                ...
                <div style={{ flex: '1 1 180px', minWidth: '180px'}}>
                    ...
                    <ul style={{ listStyle: 'none', padding: 0, margin: 0, gap: '0.5rem', display: 'flex', flexDirection: 'column' }}>
